  ...
  componentDidMount() {
    ...
    if (
      ...
      let storyData = {
        ...
        created_on: new Date(),
        sendTo:this.props.route.params.story.firstName
      };
      await firebase
        .database()
        .ref(
            ...
            >
              ...
              <View style={styles.dataContainer}>
                <View style={styles.titleTextContainer}>
                  ...
                  >
                    {this.props.route.params.story.firstName}
                  </Text>
              ...
              <View style={styles.storyTextContainer}>
                ...
                >
                 First Name: - {this.props.route.params.story.firstName}
                </Text>
                <Text
                  style={
                    this.state.light_theme
                ...
                >
                  Last Name: - {this.props.route.params.story.lastName}
                </Text>
              </View>
